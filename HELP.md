...
* The original package name 'com.wakanda.Wakanda-Cars' is invalid and this project uses 'com.wakanda.WakandaCars' instead.
...
```
$ docker run --rm -p 8080:8080 Wakanda-Cars:0.0.1-SNAPSHOT
```
